...
-- Volcando estructura de base de datos para sistema_votaciones
CREATE DATABASE IF NOT EXISTS `sistema_votaciones` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
-- Volcando datos para la tabla sistema_votaciones.candidate: ~3 rows (aproximadamente)
DELETE FROM `candidate`;
INSERT INTO `candidate` (`id`, `name`, `email`, `party`, `votes`, `available`) VALUES
...
-- Volcando datos para la tabla sistema_votaciones.voter: ~5 rows (aproximadamente)
DELETE FROM `voter`;
INSERT INTO `voter` (`id`, `name`, `email`, `has_voted`, `available`) VALUES
